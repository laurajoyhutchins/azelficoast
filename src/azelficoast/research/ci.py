...
EXPERIMENTS: tuple[CandidateExperiment, ...] = (
    ...
    _spec(
        ...
        paths=(
            ...
            "src/azelficoast/research/posterior_population_selection.py",
            "src/azelficoast/research/posterior_evidence.py",
            ...
            "src/azelficoast/research/natural_disagreements.py",
            ...
            "tests/test_posterior_evidence.py",
            "tests/test_posterior_treatments.py",
            "tests/test_matched_oracle_search.py",
            ".github/workflows/posterior-stratified-population.yml",
        ),
