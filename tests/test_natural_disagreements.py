...
from azelficoast.research.studies.natural_disagreements import UnsupportedWorldSample, mine_candidates
...
def test_legacy_unknown_item_sentinel_is_treated_as_hidden(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "azelficoast.research.studies.natural_disagreements._sample_worlds",
