...
The input is replayed through pinned Showdown to recover each player's
player-specific request stream. Azelficoast does not infer missing private
requests from the public spectator log.
